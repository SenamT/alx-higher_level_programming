...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """this will return the Rectangle which has the greater area.

        Arguments:
            rect_1: this is the initial Rectangle.
            rect_2: this is the following Rectangle.
        Raises:
    ...
    def square(cls, size=0):
        """this will return a new Rectangle where the width and height are equal to size.

        Arguments:
            size: this is the width and height of the new Rectangle.
        """
    ...
    def __repr__(self):
        """this must return the string representation of the Rectangle."""

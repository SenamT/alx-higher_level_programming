...
"""this will define unittests for the models"""
import io
import sys
import unittest
...
class TestSquare_instantiation(unittest.TestCase):
    """Unittests for testing characterization of the Square class"""
...
class TestSquare_x(unittest.TestCase):
    """Unittests for testing characterization of Square x attribute"""
...
class TestSquare_y(unittest.TestCase):
    """Unittests for testing characterization of Square y attribute"""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unittests for testing order of Square attribute characterization"""
...
class TestSquare_area(unittest.TestCase):
    """Unittests for testing the square classes area method"""
...
class TestSquare_stdout(unittest.TestCase):
    """Unittests for testing square classes __str__ and display methods"""

    @staticmethod
    def capture_stdout(sq, method):
        """this will collect and return text which is printed to the standard output

        Arguments:
            sq: this is the square which needs to be printed to standard output
            method: Tthis is the method which runs the sq
            
        Returns:
            This is the text which is printed to standard output by calling method on sq
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestSquare_update_args(unittest.TestCase):
    """Unittests for testing the squares update args method"""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Unittests for testing the squares update kwargs method"""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Unittests for testing the square classes to_dictionary method"""
